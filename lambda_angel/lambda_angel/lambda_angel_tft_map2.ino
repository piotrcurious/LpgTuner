...
WidgetElement layouts[][6] = {
  ...
  // Layout 3: Temperature Heat Map
  {
    // Widget 1: Title
    {
      ...
      0,
      "Temperature Map (C)",
      60, 5, 1, 10000, MODE_DEC,
      0, 0,
      {0, 0, WHITE, 200, 16, 0, 0, 0, 0, 0}
    },
    // Widget 2: Heat map
    {
      "tempmap",
      ...
      0, 850,
      {0, 850, WHITE, 300, 180, 0, 0, 0, 0, 0}
    },
    // Widget 3: Current RPM
    {
      "rpm",
      3,
      "RPM:",
      ...
      0, 10000,
      {0, 10000, GREEN, 100, 16, 0, 0, 0, 0, 0}
    },
    // Widget 4: Current MAP
    {
      "map",
      4,
      "MAP:",
      150, 215, 1, 100, MODE_DEC,
      0, 250,
      {0, 250, YELLOW, 100, 16, 0, 0, 0, 0, 0}
    },
    // Empty widgets
  ...
  // Layout 4: Lambda Heat Map
  {
    ...
    // Widget 2: Heat map
    {
      ...
      0.5, 1.5,
      {0.5, 1.5, WHITE, 300, 180, 0, 0, 0, 0, 0}
    },
    // Widget 3: Current RPM
    {
      "rpm",
