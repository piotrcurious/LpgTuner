...
// Define the pins
#define FREQ_PIN A2 // Analog input pin for frequency
...
#define MAX_FREQ 200 // Maximum frequency in Hz
#define MIN_PULSE 1 // Minimum pulse width in microseconds
#define MAX_PULSE 20000 // Maximum pulse width in microseconds

// Define the variables
int freq = 0; // Frequency value from FREQ_PIN
int pulse = 0; // Pulse width value from PULSE_PIN
uint32_t period = 0; // Period of the signal in microseconds
uint32_t onTime = 0; // On time of the signal in microseconds
uint32_t offTime = 0; // Off time of the signal in microseconds
